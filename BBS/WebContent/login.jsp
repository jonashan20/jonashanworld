...
<body>
	...
	<div class="container"> <%-- 로그인 양식 만들기 /컨테이너처럼 감싼다. --%>
		<div class="col-lg-4"></div>
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px;"> 
				<form method="post" action="loginAction.jsp"> <%-- form 회원가입과 로그인 같이 정보를 숨기면서 보낼때 사용함 / action=loginAction.jsp 이란 페이지로  로그인 정보주겠단 의미 --%>
